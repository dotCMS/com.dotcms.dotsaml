...
import static com.dotcms.saml.key.DotSamlConstants.DOTCMS_SAML_BUILD_ROLES_ALL_VALUE;
import static com.dotcms.saml.key.DotSamlConstants.DOTCMS_SAML_BUILD_ROLES_IDP_VALUE;
import static com.dotcms.saml.key.DotSamlConstants.DOTCMS_SAML_BUILD_ROLES_NONE_VALUE;
import static com.dotcms.saml.key.DotSamlConstants.DOTCMS_SAML_BUILD_ROLES_STATIC_ADD_VALUE;
import static com.dotcms.saml.key.DotSamlConstants.SAML_USER_ID;
import static com.dotcms.saml.util.SamlUtils.buildAuthnRequest;
import static com.dotcms.saml.util.SamlUtils.buildLogoutRequest;
import static com.dotcms.saml.util.SamlUtils.getCredential;
import static com.dotcms.saml.util.SamlUtils.getIdentityProviderDestinationEndpoint;
import static com.dotcms.saml.util.SamlUtils.getIdentityProviderSLODestinationEndpoint;
import static com.dotcms.saml.util.SamlUtils.toXMLObjectString;
...
import com.dotcms.saml.config.SamlSiteValidator;
import com.dotcms.saml.exception.AttributesNotFoundException;
import com.dotcms.saml.exception.DotSamlException;
import com.dotcms.saml.exception.NotNullEmailAllowedException;
import com.dotcms.saml.exception.SamlUnauthorizedException;
import com.dotcms.saml.handler.AssertionResolverHandler;
import com.dotcms.saml.handler.AssertionResolverHandlerFactory;
import com.dotcms.saml.key.DotSamlConstants;
import com.dotcms.saml.parameters.DotsamlPropertiesService;
import com.dotcms.saml.parameters.DotsamlPropertyName;
import com.dotcms.saml.util.SiteIdpConfigResolver;
...
public class OpenSamlAuthenticationServiceImpl implements SamlAuthenticationService {
	...
	protected AttributesBean resolveAttributes(final Assertion assertion, final IdpConfig idpConfig)
		...
		Logger.info(this, "-> Value of attributesBean = " + attributesBean.toString());
		...
		Logger.info(this, "-> Double Checked attributes = " + attributesBean);
