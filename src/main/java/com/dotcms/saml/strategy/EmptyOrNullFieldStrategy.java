...
{
	private static final long serialVersionUID = -3530366325012864393L;
	...
	{
		return ( UtilMethods.isSet( this.defaultValue ) ) ? this.defaultValue : this.preFix + attributesBean.getNameID().getValue() + this.postFix;
	}
}
